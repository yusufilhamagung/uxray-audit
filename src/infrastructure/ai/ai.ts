import type { PageType, AuditResult } from '@/shared/validation/schema';
import { AuditResultSchema } from '@/shared/validation/schema';
import { extractJsonBlock, extractTextFromResponse, safeJsonParse } from '@/shared/utils/json';
import { getMockAudit } from '@/infrastructure/ai/mock';

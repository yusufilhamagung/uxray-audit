  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="section-container relative z-10 text-center">
         <div className="mx-auto max-w-2xl rounded-3xl bg-orange-50/50 p-8 border border-orange-100">
            <h3 className="text-sm font-bold uppercase tracking-widest text-orange-600 mb-3">
              Honesty First
            </h3>
